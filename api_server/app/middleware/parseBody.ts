 ...
 */
export function parseBody(req: Request): Promise<{ [param: string]: any }> {
...
function jsonEncodedParser(body: any) {
...
function urlEncodedParser(body: any) {
  return querystring.parse(body);
}

function graphqlParser(body: any) {
  return { query: body };
}
...
function read(req: any, typeInfo: any, parseFn: any, resolve: any, reject: any) {
